...
enum OTAMode: SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct AdminMessage: Sendable {
  ...
  var backupPreferences: AdminMessage.BackupLocation {
    get {
  ...
  var restorePreferences: AdminMessage.BackupLocation {
    get {
  ...
  var removeBackupPreferences: AdminMessage.BackupLocation {
    get {
  ...
  var sendInputEvent: AdminMessage.InputEvent {
    get {
  ...
  var getUiConfigResponse: DeviceUIConfig {
    get {
  ...
  var storeUiConfig: DeviceUIConfig {
    get {
  ...
  var keyVerification: KeyVerificationAdmin {
    get {
  ...
  enum BackupLocation: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [AdminMessage.BackupLocation] = [
      .flash,
      .sd,
    ]
  ...
  struct OTAEvent: Sendable {
    ...
    var rebootOtaMode: OTAMode = .noRebootOta
...
struct NodeRemoteHardwarePinsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct KeyVerificationAdmin: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var messageType: KeyVerificationAdmin.MessageType = .initiateVerification
  ...
  var hasSecurityNumber: Bool {return self._securityNumber != nil}
  ...
  enum MessageType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [KeyVerificationAdmin.MessageType] = [
...
struct SCD4X_config: Sendable {
  ...
  var hasSetAsc: Bool {return self._setAsc != nil}
  ...
  var hasSetTargetCo2Conc: Bool {return self._setTargetCo2Conc != nil}
  ...
  var hasSetTemperature: Bool {return self._setTemperature != nil}
  ...
  var hasSetAltitude: Bool {return self._setAltitude != nil}
  ...
  var hasSetAmbientPressure: Bool {return self._setAmbientPressure != nil}
  ...
  var hasFactoryReset: Bool {return self._factoryReset != nil}
  ...
  var hasSetPowerMode: Bool {return self._setPowerMode != nil}
...
struct SEN5X_config: Sendable {
  ...
  var hasSetOneShotMode: Bool {return self._setOneShotMode != nil}
...
extension AdminMessage.InputEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = AdminMessage.protoMessageName + ".InputEvent"
  ...
  static func ==(lhs: AdminMessage.InputEvent, rhs: AdminMessage.InputEvent) -> Bool {
...
extension AdminMessage.OTAEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = AdminMessage.protoMessageName + ".OTAEvent"
  ...
  static func ==(lhs: AdminMessage.OTAEvent, rhs: AdminMessage.OTAEvent) -> Bool {
...
extension KeyVerificationAdmin: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: KeyVerificationAdmin, rhs: KeyVerificationAdmin) -> Bool {
...
extension SensorConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scd4x_config\0\u{3}sen5x_config\0")
...
extension SCD4X_config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SCD4X_config, rhs: SCD4X_config) -> Bool {
...
extension SEN5X_config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SEN5X_config, rhs: SEN5X_config) -> Bool {
    if lhs._setTemperature != rhs._setTemperature {return false}
