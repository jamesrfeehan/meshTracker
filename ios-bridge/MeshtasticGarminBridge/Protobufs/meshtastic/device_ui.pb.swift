...
enum CompassMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [CompassMode] = [
    .dynamic,
    .fixedRing,
    .freezeHeading,
  ]
...
struct DeviceUIConfig: @unchecked Sendable {
  ...
  var hasNodeFilter: Bool {return _storage._nodeFilter != nil}
  ...
  var hasNodeHighlight: Bool {return _storage._nodeHighlight != nil}
  ...
  var gpsFormat: DeviceUIConfig.GpsCoordinateFormat {
  ...
  enum GpsCoordinateFormat: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [DeviceUIConfig.GpsCoordinateFormat] = [
      .dec,
      .dms,
      .utm,
      .mgrs,
...
extension DeviceUIConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: DeviceUIConfig, rhs: DeviceUIConfig) -> Bool {
...
extension NodeFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: NodeFilter, rhs: NodeFilter) -> Bool {
...
extension NodeHighlight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: NodeHighlight, rhs: NodeHighlight) -> Bool {
