...
enum RemoteHardwarePinType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct ModuleConfig: Sendable {
  ...
  ///
  /// TODO: REPLACE
  var statusmessage: ModuleConfig.StatusMessageConfig {
    get {
  ...
  struct DetectionSensorConfig: Sendable {
    ...
    var detectionTriggerType: ModuleConfig.DetectionSensorConfig.TriggerType = .logicLow
    ...
    enum TriggerType: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      // The compiler won't synthesize support with the UNRECOGNIZED case.
      static let allCases: [ModuleConfig.DetectionSensorConfig.TriggerType] = [
        .logicLow,
        .logicHigh,
        .fallingEdge,
        .risingEdge,
...
struct RemoteHardwarePin: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ModuleConfig.StatusMessageConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = ModuleConfig.protoMessageName + ".StatusMessageConfig"
  ...
  static func ==(lhs: ModuleConfig.StatusMessageConfig, rhs: ModuleConfig.StatusMessageConfig) -> Bool {
