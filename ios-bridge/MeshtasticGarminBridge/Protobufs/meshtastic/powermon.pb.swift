...
struct PowerStressMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var cmd: PowerStressMessage.Opcode = .unset
  ...
  enum Opcode: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [PowerStressMessage.Opcode] = [
      .unset,
      .printInfo,
      .forceQuiet,
      .endQuiet,
...
extension PowerStressMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: PowerStressMessage, rhs: PowerStressMessage) -> Bool {
